...
define(["./core", "./var/document", "./var/documentElement", "./var/hasOwn", "./var/indexOf", "./var/slice", // The following utils are attached directly to the jQuery object.
"./selector/contains", "./selector/escapeSelector"], function (jQuery, document, documentElement, hasOwn, indexOf, slice) {
  "use strict";
  /*
  ...
  jQuery.extend({
    ...
    find: function find(selector, context, results, seed) {
      var elem,
          ...
          i = 0;
      results = results || [];
      context = context || document; // Same basic safeguard as in the full selector module
